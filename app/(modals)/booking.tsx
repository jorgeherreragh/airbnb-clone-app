            ...
            <BlurView intensity={70} style={styles.container} tint="light">
                            ...
                            <ScrollView
                                ...
                                {places.map((item: any, index: number) => (
                                    <TouchableOpacity onPress={() => setSelectedPlace(index)} key={index}>
                                        ...
                                        />
                                        <Text style={{ fontFamily: 'poppins', paddingTop: 6 }}>{item.title}</Text>
                                    </TouchableOpacity>
                                ))}
                            </ScrollView>
                        </Animated.View>
                        ...
                        <Animated.View style={styles.cardBody}>
                            {groups.map((item, index) => (
                                <View
                                    ...
                                    <View>
                                        <Text style={{ fontFamily: 'poppins-semi', fontSize: 14 }}>{item.name}</Text>
                                        <Text style={{ fontFamily: 'poppins', fontSize: 14, color: Colors.grey }}>
                                            {item.text}
                                        </Text>
                                    </View>
                ...
                <Animated.View style={defaultStyles.footer} entering={SlideInDown.delay(200)}>
                    <View
                        ...
                        <TouchableOpacity
                            style={[defaultStyles.button, { paddingRight: 20, paddingLeft: 50 }]}
                            onPress={() => router.back()}>
                            <Ionicons
                                name="search-outline"
                                size={24}
